...
function ModerationContent() {
    ...
    const webprofileColor = data.projects.moderation.color.background;
    const webprofileBorder = data.projects.moderation.color.border;
    const webprofileTextColor = data.projects.moderation.color.text
